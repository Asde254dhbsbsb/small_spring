...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
     ...
     * 通过循环操作，以此获取Bean配置以及配置中的id、name、value、ref信息
     * */
    protected void doLoadBeanDefinition(InputStream inputStream) throws ClassNotFoundException, BeansException {
        Document doc = XmlUtil.readXML(inputStream);
        Element root = doc.getDocumentElement();
        NodeList childNodes = root.getChildNodes();
//      每一个Element节点都是一个bean
...
//                创建属性信息
            ...
            if (getRegistry().containsBeanDefinition(beanName)) { // bean名字相同！
